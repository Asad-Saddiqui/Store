...
// const bmw = new BMW("BMW", "Red", 10000);
// console.log(bmw.getBMWName());


// // Example 5 For Abstraction
// // Abstraction is a mechanism that hides the complex implementation details and shows only the necessary features.
// // with real life example ? the car engine is a complex implementation detail, but the car is a simple object that has a name, color, and price.
...
// const bankAccount = new BankAccount("Aman", 1000);
// console.log(bankAccount.getBalance());
// console.log(bankAccount.getName());
// bankAccount.setBalance(2000);
// bankAccount.setName("Umer");
// console.log(bankAccount.getBalance());
// console.log(bankAccount.getName());
